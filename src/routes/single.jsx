  ...
  const dispatcher = useDispatch()
        ...
        <div className="container flex flex-row items-center gap-5 mt-5">
              <div className="grid grid-cols-4 grid-rows-3 w-1/3 p-1 gap-1 relative">
                 <img className="row-start-1 row-span-1  w-full h-full object-cover" src={product.thumbnail} alt="" />
                 <img className="row-start-2  w-full h-full object-cover" src={product.thumbnail}alt="" />
                 <img className="row-start-3 row-span-1  w-full h-full object-cover" src={product.thumbnail} alt="" />
                 <img className="row-start-1 row-span-full col-start-2 col-span-full w-full h-full object-cover" src={product.thumbnail} alt="" />
              </div>
